...
# -d 0  : device address - omit this if only one dongle
...
# -a POCSAG512 -a POCSAG1200 -a POCSAG2400 -a FLEX : set to the protocol you're decoding
...
######################################################################
rtl_fm -d 0 -E dc -F 0 -l 15 -A fast -f 157.950M -s22050 - | 
multimon-ng -q -b1 -c -a POCSAG512 -a POCSAG1200 -a POCSAG2400 -a FLEX -f alpha -t raw /dev/stdin | 
node reader.js